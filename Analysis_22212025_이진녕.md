...
flowchart LR
    ...
    subgraph OSS_Engine [ ]
        direction TB
        %% 시스템 명칭 (경계 내부 상단에 배치)
        SystemName["<b>[ OSS Mall Engine (쇼핑몰 엔진 시스템) ]</b>"]
    ...
    %% 스타일링 (더 깔끔한 가독성)
    style OSS_Engine fill:#fff,stroke:#333,stroke-width:2px,stroke-dasharray: 5 5
    style SystemName fill:none,stroke:none,font-size:16px
    style UC1 fill:#f9f9f9,stroke:#333
    style UC2 fill:#f9f9f9,stroke:#333
    style UC3 fill:#f9f9f9,stroke:#333
    style UC4 fill:#f9f9f9,stroke:#333
    style UC5 fill:#f9f9f9,stroke:#333
    style Customer fill:#eef,stroke:#333
    style Owner fill:#eef,stroke:#333
    style PG fill:#eee,stroke:#333
```
